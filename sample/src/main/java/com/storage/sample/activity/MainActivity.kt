...
import com.storage.sample.helper.extension.launchOnUiThread
...
import com.storage.sample.StorageInfoAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private val rwPermission: Array<String>
        get() = arrayOf(Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE)
...
//        get() = arrayOf(Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupButtonActions(savedInstanceState)
    }
    ...
    private fun setupButtonActions(savedInstanceState: Bundle?) {
        ...
        btnCaptureImage.setOnClickListener {
            storageHelper.captureImage(REQUEST_CAPTURE_IMAGE)
        }
    ...
    companion object {
        ...
        const val REQUEST_CAPTURE_IMAGE = 19
